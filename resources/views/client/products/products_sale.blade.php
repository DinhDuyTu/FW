                                ...
                                <div class="box-hover">
                                    <div class="product-item-actions">
                                        <div class="pro-actions">
                                            <button class="action add-to-cart btn-quickview" type="button" title="Add to Cart" data-id="{{ $prd_sale->id }}" data-toggle="modal" data-target="#quick-view-modal"> <span>Add to Cart</span> </button>
                                        </div>
