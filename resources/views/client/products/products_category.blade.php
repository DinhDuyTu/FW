                                    ...
                                    <div class="box-hover">
                                        <div class="product-item-actions">
                                            ...
                                            <div class="add-to-links" data-role="add-to-links">
                                                <a class="action add-to-wishlist icon-add-to-wishlist" data-prd-id="{{ Auth::check() ? $prd['id'] : '' }}" title="Add to Wishlist"> <span>Wishlist</span> </a>
                                                <a class="action add-to-compare" title="Add to Compare"> <span>Compare</span> </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
