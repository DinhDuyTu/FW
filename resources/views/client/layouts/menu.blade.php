                ...
                <div class="main-menu">
                    <nav>
                        <ul>
                            ...
                            <li class="{{ url()->current() == route('list_product') ? 'active' : '' }} megamenu"><a href="{{ route('list_product') }}">Products</a>
