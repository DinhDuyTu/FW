<div class="our-clients"><div class="our-clients">
    <div class="slider-items-products">
        <div id="our-clients-slider" class="product-flexslider hidden-buttons">
            <div class="slider-items slider-width-col6">
                <div class="item">
                    <a href="#"><img src="{{ asset('bower_components/Asset-FW-Client/images/brand1.html') }}" alt="Image"></a>
                </div>
                <div class="item">
                    <a href="#"><img src="{{ asset('bower_components/Asset-FW-Client/images/brand2.png') }}" alt="Image"></a>
                </div>
                <div class="item">
                    <a href="#"><img src="{{ asset('bower_components/Asset-FW-Client/images/brand3.png') }}" alt="Image"></a>
                </div>
                <div class="item">
                    <a href="#"><img src="{{ asset('bower_components/Asset-FW-Client/images/brand4.png') }}" alt="Image"></a>
                </div>
                <div class="item">
                    <a href="#"><img src="{{ asset('bower_components/Asset-FW-Client/images/brand5.png') }}" alt="Image"></a>
                </div>
                <div class="item">
                    <a href="#"><img src="{{ asset('bower_components/Asset-FW-Client/images/brand6.png') }}" alt="Image"></a>
                </div>
                <div class="item">
                    <a href="#"><img src="{{ asset('bower_components/Asset-FW-Client/images/brand7.png') }}" alt="Image"></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-3">
                    <div class="footer-logo">
                        <a href="index.html"><img src="{{ asset('bower_components/Asset-FW-Client/images/logo.png') }}" alt="fotter logo"></a>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-xs-12">
                    <div class="payment">
                        <ul>
                            <li>
                                <a href="#"><img title="Visa" alt="Visa" src="{{ asset('bower_components/Asset-FW-Client/images/visa.png') }}"></a>
                            </li>
                            <li>
                                <a href="#"><img title="Paypal" alt="Paypal" src="{{ asset('bower_components/Asset-FW-Client/images/paypal.png') }}"></a>
                            </li>
                            <li>
                                <a href="#"><img title="Discover" alt="Discover" src="{{ asset('bower_components/Asset-FW-Client/images/discover.png') }}"></a>
                            </li>
                            <li>
                                <a href="#"><img title="Master Card" alt="Master Card" src="{{ asset('bower_components/Asset-FW-Client/images/master-card.png') }}"></a>
                            </li>
                        </ul>
                    </div>
                </div>
