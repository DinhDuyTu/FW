<footer>
  ...
  <p> <i class="fa fa-envelope"></i><span><a href="mailto:support@example.com">support@example.com</a></span></p>
  </address>
            </div>
        </div>
    </div>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <div class="col-sm-7 col-md-6 col-xs-12 coppyright">Copyright © 2018 <a href="#"> Fabulous </a>. All Rights Reserved. </div>
                <div class="col-sm-5 col-md-6 col-xs-12 payment-accept">
                    <ul>
                        <li>
                            <a href="#"><img class="img-responsive" src="images/payment-1.png" alt="Payment Card"></a>
                        </li>
                        <li>
                            <a href="#"><img class="img-responsive" src="images/payment-2.png" alt="Payment Card"></a>
                        </li>
                        <li>
                            <a href="#"><img class="img-responsive" src="images/payment-3.png" alt="Payment Card"></a>
                        </li>
                        <li>
                            <a href="#"><img class="img-responsive" src="images/payment-4.png" alt="Payment Card"></a>
                        </li>
                    </ul>
                </div>
            </div>
